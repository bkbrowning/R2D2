// -----------------------------------------------
// ServoExpanderDomePies
// Brent Browning
// v3.1 - 2018-02 - Fixed byte handler for receiving integer on I2C bus
// v3.2 - 2018-02 - Revised panel animations to be consistent with Dome Panels
// -----------------------------------------------
...
#define STATUS_LED 13 // Our Status LED on Arduino Digital IO #13, this is the built in LED on the Pro Mini
                      // NOTE: Be sure to use pin 13 with caution as it can sometimes be shared with a live servo, etc. and not be jsut the LED
...
#define NUMBER_OF_SERVOS 5 // total number of servos in the servo array below
VarSpeedServo Servos[NUMBER_OF_SERVOS];  // array to link all servos to the VarSpeedServo library
int myServos[NUMBER_OF_SERVOS][5] = {{ 2, 150, 40, 100, 100 },
                                     { 3, 150, 40, 100, 100 },
                                     { 4, 150, 40, 100, 100 },
                                     { 5, 160, 40, 100, 100 },
                                     { 6, 120, 40, 100, 100 }};
...
int myi2c = 13; // The i2c address for this servo expander!  Important that this be unique.  If you have more than one servo expander, be sure to change this variable
...
void setup() {
  ...
  Serial.println("STEALTH Servo Expander initializing - DOME PIES");
...
// -----------------------------------------------------
// -----------------------------------------------------
// Main Arduino Processing Loop - runs continuously
// -----------------------------------------------------
// -----------------------------------------------------
void loop() {
  delay(60);  // slow the loop a bit to allow for signals to process completely as I2C is slower than the loop
...
void OpenCloseSinglePanel() {
    ...
    int PANELACTION = PIE0; // SET THE PANEL# THAT NEEDS TESTING!
